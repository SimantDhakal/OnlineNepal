...
class ListTimelineAdapter extends BaseAdapter {
    private Activity activity;
    private ArrayList<HashMap<String, String>> data;

    public ListTimelineAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    }
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ListTimelineViewHolder holder = null;
        if (convertView == null) {
            holder = new ListTimelineViewHolder();
            ...
            holder = (ListTimelineViewHolder) convertView.getTag();
        }
